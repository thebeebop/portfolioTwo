      ...
      <div className="app">
        ...
        <section className="brief-history-section">
          ...
          <p>
            ...
            decided that I wanted to pursue a different career path and started
          ...
          <p>
            ...
            learnt the fundamentals of JavaScript, built my own API and created
            a social news web application with React, HTML & CSS.
          </p>
          <div className="arrow"></div>
          <div className="mock-image"></div>
          <p>
